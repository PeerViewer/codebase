// the vnc server listens on port 55900 (non-standard because another vnc server might be listening on the standard 5900)
// the hypertele listens on port 45900,
// so the vnc client also connects to port 45900
